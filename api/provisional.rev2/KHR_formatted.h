...
KD_API KDint KD_APIENTRY kdVsscanffKHR(const KDchar *str, const KDchar *format, KDVaListKHR ap);
...
KD_API KDint KD_APIENTRY kdVfscanffKHR(KDFile *file, const KDchar *format, KDVaListKHR ap);
