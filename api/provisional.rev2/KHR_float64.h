...
/* kdFtostrKHR: Convert a 64-bit float to a string. */
#define KD_DTOSTR_MAXLEN_KHR 27
KD_API KDssize KD_APIENTRY kdDtostr(KDchar *buffer, KDsize buflen, KDfloat64KHR number);
