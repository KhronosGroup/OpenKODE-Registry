/* Sample KD/kd.h for OpenKODE Core 1.0 Provisional Revision 2 update (draft 4692) */
#ifndef __kd_h_
#define __kd_h_
 ...
 *******************************************************/
#define KD_VERSION_1_0_PROVISIONAL 1
typedef char KDchar;
...
KD_API EGLNativeWindowType KD_APIENTRY kdRealizeWindow(KDWindow *window);
